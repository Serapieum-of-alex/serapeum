...
# Load a tokenizer
tokenizer = AutoTokenizer.from_pretrained("bert-base-uncased", model_dir=model_dir)

# Example long text
text = (
    "This is a long text that needs to be chunked. " * 100
)  # Simulating a long document
