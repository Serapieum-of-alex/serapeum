...
from serapeum.core.utils.base import Thread
...
class HuggingFaceLLM(CustomLLM):
    ...
    context_window: int = Field(
        ...
        description=(Metadata.model_fields["context_window"].description),
        gt=0,
    )
    ...
    is_chat_model: bool = Field(
        default=False,
        description=(
            Metadata.model_fields["is_chat_model"].description
    ...
    def _tokenizer_messages_to_prompt(self, messages: Sequence[Message]) -> str:
