...
```python
from serapeum.embeddings.ollama import OllamaEmbedding
...
```python
from serapeum.core import VectorStoreIndex, Settings
from serapeum.embeddings.ollama import OllamaEmbedding
...
For more detailed examples, see the [Ollama Embeddings notebook](https://github.com/run-llama/serapeum/blob/main/docs/examples/embeddings/ollama_embedding.ipynb) in the LlamaIndex documentation.
