...
class TestResponses:
    ...
    def test_mro_includes_base_llm(self) -> None:
        ...
        assert BaseLLM.__name__ in mro_names, (
            f"BaseLLM not found in MRO: {mro_names}"
        )
    ...
    def test_class_name(self) -> None:
        ...
        """
        assert Responses.class_name() == "azure_openai_responses", (
    ...
    def test_engine_alias_deployment_name(self) -> None:
        ...
        assert llm.engine == "my-dep", (
            f"Expected engine 'my-dep', got '{llm.engine}'"
        )
    ...
    def test_api_base_reset_when_azure_endpoint_set(self) -> None:
        ...
        assert llm.api_base is None, (
            f"Expected api_base None, got '{llm.api_base}'"
        )
    ...
    def test_get_model_kwargs_uses_engine(
        ...
        assert kwargs["model"] == "my-responses-deployment", (
...
class TestResponsesCredentials:
    ...
    def test_azure_ad_refresh_fallback(
        ...
        assert key == "refreshed-token", (
            f"Expected 'refreshed-token', got '{key}'"
        )
...
class TestResponsesWithMocks:
    ...
    def test_custom_azure_ad_token_provider(
        self, sync_azure_mock: MagicMock
    ) -> None:
    ...
    def test_non_streaming_complete(self, sync_azure_mock: MagicMock) -> None:
        ...
        assert response.text == "Hello from Azure Responses", (
    ...
    def test_non_streaming_chat(self, sync_azure_mock: MagicMock) -> None:
        ...
        assert response.message.content == "Chat reply from Azure", (
    ...
    def test_streaming_complete(self, sync_azure_mock: MagicMock) -> None:
        ...
        assert "Azure" in responses[-1].text, (
    ...
    async def test_async_non_streaming_complete(
        ...
        assert response.text == "Async Azure reply", (
    ...
    async def test_async_non_streaming_chat(
        ...
        assert response.message.content == "Async chat reply", (
    ...
    @pytest.mark.asyncio
    @patch("serapeum.azure_openai.llm.AsyncAzureOpenAI")
    async def test_async_streaming_complete(
        self, async_azure_mock: MagicMock
    ) -> None:
