...
class FunctionConverter:
    ...
    # Fix doctest: use explicit variable names in generator expression
    # Example: sorted((k, v[0].__name__) for k, v in merged.items())
    # becomes: sorted((item[0], item[1][0].__name__) for item in merged.items())
