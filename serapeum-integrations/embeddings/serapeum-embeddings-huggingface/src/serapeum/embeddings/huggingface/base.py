...
from serapeum.embeddings.huggingface.pooling import Pooling
from serapeum.core.embeddings.multi_modal_base import MultiModalEmbedding
from serapeum.core.utils.base import get_cache_dir, infer_torch_device
from serapeum.embeddings.huggingface.utils import (
...
class HuggingFaceEmbedding(MultiModalEmbedding):
    ...
    Examples:
        ...
        ```python
        from serapeum.core import Settings
        from serapeum.embeddings.huggingface import HuggingFaceEmbedding
